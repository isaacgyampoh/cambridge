...
const PUBLIC = [
  ...
  '/portal', '/api/student/', '/api/auth/', '/api/setup/', '/api/signin/', '/api/classes/signin', '/api/classes/pay', '/api/fees/pay', '/api/webhooks/', '/api/applications/', '/api/referrals/', '/api/courses/public', '/api/paystack/key', '/api/paystack/init', '/api/paystack/verify', '/api/social/', '/api/flyers/public', '/api/flyers/submit', '/api/upload', '/_next', '/favicon',
