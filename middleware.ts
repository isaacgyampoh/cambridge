...
const PUBLIC = [
  ...
  '/api/auth/', '/api/setup/', '/api/signin/', '/api/classes/signin', '/api/webhooks/', '/api/applications/', '/_next', '/favicon',
]
...
const PORTAL_PATHS: Record<string, string[]> = {
  ...
  leads:       ['/admin/leads', '/admin/pipeline', '/admin/conversions', '/admin/transfers'],
