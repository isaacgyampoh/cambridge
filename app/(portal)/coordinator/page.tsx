        ...
        {edit && (
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              {/* Exam voucher — coordinator REQUESTS; finance buys & inputs it */}
                ...
                {edit.voucher_code && edit.voucher_sent_at ? (
                  ...
                  <>
                    ...
                    <Button variant="secondary" disabled={saving}
                      onClick={async () => {
                        setSaving(true)
                        const d = await fetch('/api/prep/voucher', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ action: 'request', prep_record_id: edit.id }) }).then(r => r.json()).catch(() => ({ error: 'failed' }))
                        setSaving(false)
