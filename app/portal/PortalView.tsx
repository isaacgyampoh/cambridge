...
export default function PortalView({ demo, demoData }: { demo?: boolean; demoData?: any }) {
  ...
  async function pay() {
    if (demo) { alert('Demo: this opens Paystack (MoMo or card) for the student to pay.'); return }
  ...
  async function joinClass() {
    if (demo) { alert('Demo: this opens the class link and records the sign-in.'); return }
