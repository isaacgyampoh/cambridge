...
export async function POST(req: NextRequest) {
  ...
  const prompts: Record<string, string> = {
    ...
    shadow: `Here is a competitor's post/ad:\n\n${input}\n\nExplain: (1) what makes it work, (2) how Cambridge Centre of Excellence can create a stronger version without copying, (3) the exact hook/caption we should use, and (4) the best time and format to post our version. Be concrete.`,
    content_ideas: `Give 10 specific, scroll-stopping social media content ideas for Cambridge Centre of Excellence (PMP, HR certifications, Agile PM, M&E training in Ghana). For each: the hook, the format (reel/carousel/etc), and why it would get engagement or leads. Avoid generic 'motivational' fluff — make them concrete and locally relevant to Ghana.`,
  }
